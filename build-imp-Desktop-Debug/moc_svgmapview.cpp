...
void SvgMapView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SvgMapView *_t = static_cast<SvgMapView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (SvgMapView::*_t)(const QString & );
        ...
        {
            typedef void (SvgMapView::*_t)(int );
...
const QMetaObject SvgMapView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_SvgMapView.data,
      qt_meta_data_SvgMapView,  qt_static_metacall, nullptr, nullptr}
};
