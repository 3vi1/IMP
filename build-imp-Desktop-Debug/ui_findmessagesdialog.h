...
public:
    ...
    void setupUi(QDialog *FindMessagesDialog)
    {
        if (FindMessagesDialog->objectName().isEmpty())
            FindMessagesDialog->setObjectName(QStringLiteral("FindMessagesDialog"));
    ...
    {
        FindMessagesDialog->setWindowTitle(QApplication::translate("FindMessagesDialog", "Find Messages", Q_NULLPTR));
        label->setText(QApplication::translate("FindMessagesDialog", "Contains:", Q_NULLPTR));
    } // retranslateUi
