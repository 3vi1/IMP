...
void LogCatcher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LogCatcher *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (LogCatcher::*)(const QString & );
...
QT_INIT_METAOBJECT const QMetaObject LogCatcher::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_LogCatcher.data,
    qt_meta_data_LogCatcher,
    qt_static_metacall,
    nullptr,
    nullptr
} };
